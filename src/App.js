  ...
  render(){
    ...
    const handleSave=()=>{
      ...
      for (let index = 0; index < this.state.backlog.length; index++) {
        var title = document.getElementById(index + 'title-backlog').innerHTML;
        var description = document.getElementById(index + 'description-backlog').innerHTML;
        tempState.backlog[index] = [title,description];
      }
      for (let index = 0; index < this.state.toDo.length; index++) {
        var title = document.getElementById(index + 'title-toDo').innerHTML;
        var description = document.getElementById(index + 'description-toDo').innerHTML;
        tempState.toDo[index] = [title,description];
      }
      for (let index = 0; index < this.state.inProgress.length; index++) {
        var title = document.getElementById(index + 'title-inProgress').innerHTML;
        var description = document.getElementById(index + 'description-inProgress').innerHTML;
        tempState.inProgress[index] = [title,description];
      }
      for (let index = 0; index < this.state.done.length; index++) {
        var title = document.getElementById(index + 'title-done').innerHTML;
        var description = document.getElementById(index + 'description-done').innerHTML;
